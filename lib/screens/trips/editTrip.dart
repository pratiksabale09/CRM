//file not rendered in application currently, just for the demo of stepper form
//render TripsScreen in file slidingtripdrawer on line 53 instead of googlemap widget
import 'package:car_rental_mng_app/models/trip.dart';
import 'package:flutter/material.dart';

class Tripsform extends StatefulWidget {
  Trip gottrip;
  Tripsform({Key? key, required this.gottrip}) : super(key: key);
